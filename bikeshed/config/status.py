...
megaGroups = {
    "w3c": frozenset(["act-framework", "audiowg", "csswg", "dap", "fxtf", "fxtf-csswg", "geolocation", "houdini", "html", "i18n", "immersivewebwg", "mediacapture", "processcg", "ricg", "sacg", "serviceworkers", "svg", "texttracks", "uievents", "wasm", "web-bluetooth-cg", "webapps", "webappsec", "webauthn", "webml", "web-payments", "webperf", "webplatform", "webrtc", "webspecs", "webvr", "wicg"]),
...
def canonicalizeStatus(rawStatus, group):
    ...
    def megaGroupsForStatus(status):
        ...
        megaGroups = []
        for key in list(shortToLongStatus.keys()):
